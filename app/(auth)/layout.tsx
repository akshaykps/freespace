        ...
        <div className={"flex min-h-screen"}>
            <section className={"bg-brand p-10 hidden w1/2 items-center justify-center lg:flex xl:w-2/5"}>
                <div className="flex max-h-[800px] max-w-[430px] flex-col justify-center space-y-12">
                    <Image src={"/assets/icons/logo-full.svg"} alt={"logo"} height={82} width={224} />
                    <div className="space-y-5 text-white">
                        <h1 className={"h1"}>Manage all your digital belongings at it's best way</h1>
                        <p className={"body-1"}>
                            This is the place where you can store all your documents and other files
                        </p>
                    </div>
